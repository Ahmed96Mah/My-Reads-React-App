...
const SignUp = () => {
  ...
  return (
    // If the user chooses to signup, display the signup page
    Choice === 'signup' ? (
      <div className="form">
        <h1>
        ...
        <div className="no">
          <span>
            <span className="action">Already</span> Have an Account?
          </span>{' '}
          <button name="login" onClick={onSetChoice}>
            Login
          </button>
        </div>
      </div>
    ) : (
      // If the user chooses to login, display the login page
      <div className="form">
        <h1>
        ...
        <div className="no">
          <span>
            <span className="action">Don't</span> Have an account?
          </span>{' '}
          <button name="signup" onClick={onSetChoice}>
            SignUp
          </button>
        </div>
      </div>
